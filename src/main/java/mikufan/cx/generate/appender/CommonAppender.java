...
public class CommonAppender {
  ...
  public void addEclispeCollAndLombokImport(StringBuilder classStringBuilder) {
  ...
  public void addLombokConstructorAnnotationOnClass(StringBuilder classStringBuilder) {
